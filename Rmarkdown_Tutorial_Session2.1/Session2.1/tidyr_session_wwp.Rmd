...
Let's explore how this can be done using an unmodified **WWP** dataset. This data will be used in the afternoon session to conduct a Genome Wide Association Study (GWAS).
...
Specifically the dataset consists of $\delta$^13^*C* measured on 779 seedlings. Environmental data for the populations was also obtained from **WHERE**
